...
class SpeechFrameDetector:
    def __init__(
        ...
        min_speech_duration_ms = int(
            os.getenv("MIN_SPEECH_DURATION_MS", str(min_speech_duration_ms))
        )
        max_speech_duration_s = float(
            os.getenv("MAX_SPEECH_DURATION_S", str(max_speech_duration_s))
        )
        min_silence_duration_ms = int(
            os.getenv("MIN_SILENCE_DURATION_MS", str(min_silence_duration_ms))
        )
